...
%type <string> Type
%type <ast> Program DeclList Decl VarDecl Stmt StmtList Expr ParamDeclList ParamDecl Block BlockList FuncDeclList FuncDecl FuncID Primary ExprList Condition IfBlock
...
BlockList: %empty					{$$ = AST.addNode("BlockEnd",NULL,NULL);}
		| BlockList StmtList		{$$ = AST.addNode("BlockList",$2,$1);
									//FINISH?
									}
