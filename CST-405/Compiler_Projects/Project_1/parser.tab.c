...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RCBRA = 15,                     /* RCBRA  */
  YYSYMBOL_LCBRA = 16,                     /* LCBRA  */
  ...
  YYSYMBOL_RBRA = 23,                      /* RBRA  */
  YYSYMBOL_UNARY = 24,                     /* UNARY  */
  YYSYMBOL_YYACCEPT = 25,                  /* $accept  */
  YYSYMBOL_Program = 26,                   /* Program  */
  YYSYMBOL_FuncDeclList = 27,              /* FuncDeclList  */
  YYSYMBOL_FuncDecl = 28,                  /* FuncDecl  */
  YYSYMBOL_ParamDeclList = 29,             /* ParamDeclList  */
  YYSYMBOL_Block = 30,                     /* Block  */
  YYSYMBOL_BlockList = 31,                 /* BlockList  */
  YYSYMBOL_ParamDecl = 32,                 /* ParamDecl  */
...
{
       0,    80,    80,    82,    84,    85,    88,    94,    95,    96,
     101,   104,   105,   108,   113,   117,   133,   151,   163,   164,
     170,   171,   174,   175,   176,   177,   180,   185,   186,   187,
     219,   222,   225,   228,   231,   234,   237,   240,   243,   246,
     249,   255,   261,   264,   265,   268,   274,   275,   276
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "NUMBER", "WRITE", "READ", "WRITELN", "RETURN",
  "LPAR", "LBRA", "RCBRA", "LCBRA", "COMMA", "PLUS", "MINUS", "MULT",
  "DIV", "RPAR", "RBRA", "UNARY", "$accept", "Program", "FuncDeclList",
  "FuncDecl", "ParamDeclList", "Block", "BlockList", "ParamDecl",
  "VarDecl", "Type", "StmtList", "Stmt", "Expr", "Primary", "ExprList", YY_NULLPTR
};
...
{
      59,   -28,   -28,     5,   -28,    59,    46,   -28,   -28,   -28,
      51,    59,    43,    25,    61,    52,    59,    53,   -28,   -28,
     -28,    47,    41,   -28,    13,   -28,    40,    20,    63,    20,
     -28,   -28,    66,   -28,    29,    -3,   -28,    20,    20,    64,
      24,    31,    65,    67,    -2,   -28,     1,    16,   -28,   -28,
      20,    20,   -28,    37,    54,    55,    13,    40,    57,    13,
      40,   -28,   -28,   -28,   -28,   -28,   -28,    71,    57,   -28,
      20,   -28,    73,    58,   -28,    20,    68,   -28,   -28
};
...
{
       0,    19,    18,     0,     2,     4,     0,     1,     3,     5,
       0,     7,     0,     8,     0,     0,     7,    14,    11,     6,
       9,     0,     0,    15,    28,    22,    43,     0,     0,     0,
      10,    13,     0,    12,    20,     0,    27,     0,    46,     0,
       0,     0,     0,     0,     0,    26,     0,     0,    21,    23,
       0,     0,    29,    47,     0,     0,    28,    38,    36,    28,
      33,    31,    39,    34,    24,    25,    16,     0,    35,    30,
      46,    44,    45,     0,    48,     0,     0,    41,    17
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -28,   -28,    56,   -28,    69,   -28,   -28,   -28,   -28,   -10,
      48,   -28,   -27,   -28,    14
};
...
{
      44,    14,    46,    49,    64,     7,    14,    65,     1,     2,
      52,    53,    32,    58,    61,    50,    50,    51,    51,    50,
      37,    51,    66,    68,    69,    24,    38,    39,    26,    56,
      67,    40,    57,    41,    24,    25,    59,    26,    27,    60,
      28,    29,    16,    53,     1,     2,    24,    25,    77,    26,
      27,    10,    28,    29,    70,    50,    30,    51,    42,     8,
      43,     9,     1,     2,    11,    15,    17,    21,    18,    45,
      23,    47,    55,    62,    78,    63,    71,    51,    72,    73,
      75,    76,    48,     0,    74,    20
};

static const yytype_int8 yycheck[] =
{
      27,    11,    29,     6,     6,     0,    16,     6,     3,     4,
      37,    38,    22,    40,    41,    18,    18,    20,    20,    18,
       7,    20,     6,    50,    51,     5,    13,    14,     8,     5,
      14,    18,     8,    20,     5,     6,     5,     8,     9,     8,
      11,    12,    17,    70,     3,     4,     5,     6,    75,     8,
       9,     5,    11,    12,    17,    18,    15,    20,    18,     3,
      20,     5,     3,     4,    13,    22,     5,    14,    16,     6,
      23,     5,     8,     8,     6,     8,    22,    20,    23,     8,
       7,    23,    34,    -1,    70,    16
};
...
{
       0,     3,     4,    26,    27,    28,    34,     0,    27,    27,
       5,    13,    29,    32,    34,    22,    17,     5,    16,    30,
      29,    14,    31,    23,     5,     6,     8,     9,    11,    12,
      15,    33,    34,    35,    36,    37,    38,     7,    13,    14,
      18,    20,    18,    20,    37,     6,    37,     5,    35,     6,
      18,    20,    37,    37,    39,     8,     5,     8,    37,     5,
       8,    37,     8,     8,     6,     6,     6,    14,    37,    37,
      17,    22,    23,     8,    39,     7,    23,    37,     6
};
...
#line 1233 "parser.tab.c"
  ...
  case 11: /* BlockList: %empty  */
#line 104 "parser.y"
                                                        {(yyval.ast) = NULL;}
#line 1239 "parser.tab.c"
    break;

  case 12: /* BlockList: BlockList StmtList  */
#line 105 "parser.y"
...
#line 1247 "parser.tab.c"
  ...
  case 13: /* BlockList: BlockList VarDecl  */
#line 108 "parser.y"
                                                        {(yyval.ast) = AST.addNode("BLockList",(yyvsp[-1].ast),(yyvsp[0].ast));
									//FINISH?
									}
...
#line 1264 "parser.tab.c"
  ...
  case 15: /* ParamDecl: Type ID LBRA RBRA  */
#line 117 "parser.y"
                                    {(yyval.ast) = AST.addNode((yyvsp[-2].string), NULL, NULL);}
#line 1270 "parser.tab.c"
    break;

  case 16: /* VarDecl: Type ID SEMICOLON  */
#line 133 "parser.y"
...
#line 1293 "parser.tab.c"
  ...
  case 17: /* VarDecl: Type ID LBRA NUMBER RBRA SEMICOLON  */
#line 151 "parser.y"
                                                     {
								printf("\n ARRAY NUMBER %d\n", (yyvsp[-2].number));
								printf("HUH? %s\n", (yyvsp[-4].string));
								for (int x = 0; x < (yyvsp[-2].number); x++){
									string n = cBS((yyvsp[-4].string));
									printf("|%s", n);
								}
...
#line 1344 "parser.tab.c"
  ...
  case 24: /* Stmt: WRITE Expr SEMICOLON  */
#line 176 "parser.y"
...
#line 1378 "parser.tab.c"
  ...
  case 29: /* Expr: ID EQ Expr  */
#line 187 "parser.y"
                        { printf("\n RECOGNIZED RULE: Assignment statement\n"); 
					// ---- SEMANTIC ACTIONS by PARSER ----
					  (yyval.ast) = AST.addNode("=",AST.addNode((yyvsp[-2].string), NULL, NULL),(yyvsp[0].ast));
					// Semantic ananysic
					...
					if(found((yyvsp[0].ast)->data, currentScope) != 1){
						printf("Semantic error: Variable %s has not been declared in scope %s \n", (yyvsp[0].ast), currentScope);
						semanticCheckPassed = 0;
					}

					printf("\nChecking types: \n");
					int typeMatch = compareTypes ((yyvsp[-2].string), (yyvsp[0].ast)->data, currentScope);
					if (typeMatch == 0){
						printf("Semantic error: Type mismatch for variables %s and %s \n", (yyvsp[-2].string), (yyvsp[0].ast));
						semanticCheckPassed = 0;
					}
...
#line 1431 "parser.tab.c"
  ...
  case 32: /* Expr: ID MULT ID  */
#line 225 "parser.y"
                        {printf("\n RECOGNIZED RULE: MULT statement\n");
				(yyval.ast) = AST.addNode("*",AST.addNode((yyvsp[-2].string), NULL, NULL),AST.addNode((yyvsp[0].string), NULL, NULL));
				}
#line 1439 "parser.tab.c"
    break;

  case 33: /* Expr: ID MULT NUMBER  */
#line 228 "parser.y"
                                {printf("\n RECOGNIZED RULE: MULT statement\n");
				(yyval.ast) = AST.addNode("*",AST.addNode((yyvsp[-2].string), NULL, NULL),AST.addNum((yyvsp[0].number)));
				}
#line 1447 "parser.tab.c"
    break;

  case 34: /* Expr: NUMBER MULT NUMBER  */
#line 231 "parser.y"
                                {printf("\n RECOGNIZED RULE: MULT statement\n");
				(yyval.ast) = AST.addNode("*",AST.addNum((yyvsp[-2].number)),AST.addNum((yyvsp[0].number)));
				}
...
#line 1487 "parser.tab.c"
  ...
  case 39: /* Expr: NUMBER PLUS NUMBER  */
#line 246 "parser.y"
                                {printf("\n RECOGNIZED RULE: MULT statement\n");
				(yyval.ast) = AST.addNode("+",AST.addNum((yyvsp[-2].number)),AST.addNum((yyvsp[0].number)));
				}
#line 1495 "parser.tab.c"
  ...
  case 40: /* Expr: ID EQ Expr  */
#line 249 "parser.y"
                        { printf("\n RECOGNIZED RULE: Assignment statement\n"); 
					   // ---- SEMANTIC ACTIONS by PARSER ----
					   char str[50];
					   sprintf(str, "%d", (yyvsp[0].ast)); 
					   (yyval.ast) = AST.addNode("=",AST.addNode((yyvsp[-2].string), NULL, NULL), (yyvsp[0].ast));
					}
#line 1506 "parser.tab.c"
    break;

  case 41: /* Expr: ID LBRA NUMBER RBRA EQ Expr  */
#line 255 "parser.y"
                                      {//Get Array BS in here
								//FINISH Array
								(yyval.ast) = AST.addNode("=",NULL,NULL);
								}
...
#line 1529 "parser.tab.c"
  ...
  case 44: /* Primary: ID LPAR ExprList RPAR  */
#line 265 "parser.y"
...
#line 1537 "parser.tab.c"
  ...
  case 45: /* Primary: ID LBRA NUMBER RBRA  */
#line 268 "parser.y"
                                        {(yyval.ast) = AST.addNode("Array",NULL,NULL);
								//FINISH Array
								}
...
#line 1557 "parser.tab.c"
  ...
  case 48: /* ExprList: Expr COMMA ExprList  */
#line 276 "parser.y"
